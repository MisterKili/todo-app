...
class ProjectServiceTest {
    ...
    @Test
    @DisplayName("should throw IllegalArgumentException when configured to allow just 1 group and no projects for a given id")
    void createGroup_noMultipleGroupsConfig_And_undoneGroupsExist_noProjects_throwsIllegalArgumentException() {
        // given
        var mockRepository = mock(ProjectRepository.class);
        when(mockRepository.findById(anyInt())).thenReturn(Optional.empty());
        // and
